...
function JumpingCharacter:new(x,y,char,speed,xDir,jumpAcc,interval,color,score)
	local jumpCharacter <const> = setmetatable(Body:new(x,y,char,speed,xDir,color,score),self)
